...
def parse_row(row):
    ...
    if n == 54:
        return {
            ...
            "horizon_real_window_median": row[14],
            "horizon_real_window_mean": row[15],
            "horizon_theory": row[16],
            "horizon_theory_time": row[17],
            "error_mode": row[18],
            "error_factor": row[19],
            "error_tolerance": row[20],
            "error_tolerance_used": row[21],
            "calib_ratio": row[22],
            "model_error": row[23],
            "model_error_mode": row[24],
            "model_error_mean": row[25],
            "delta_local": row[26],
            "delta_local_k": row[27],
            "delta_local_quantile": row[28],
            "delta_local_samples": row[29],
            "horizon_model": row[30],
            "horizon_model_time": row[31],
            "horizon_est": row[32],
            "horizon_est_time": row[33],
            "expansion_quantile": row[34],
            "expansion_samples": row[35],
            "expansion_theiler": row[36],
            "expansion_dim": row[37],
            "expansion_lag": row[38],
            "expansion_horizon": row[39],
            "expansion_Lq": row[40],
            "expansion_mean": row[41],
            "growth_source": row[42],
            "growth_horizon": row[43],
            "growth_Lq": row[44],
            "growth_Lmean": row[45],
            "bound_mode": row[46],
            "calibration_alpha": row[47],
            "calibration_floor": row[48],
            "calibration_scale": row[49],
            "calibration_samples": row[50],
            "calibration_coverage": row[51],
            "horizon_model_cal": row[52],
            "horizon_model_cal_time": row[53],
        }
    if n == 52:
        return {
            "dataset": row[0],
